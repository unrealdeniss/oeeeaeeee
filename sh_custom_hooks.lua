...
File Path:   addons/zeros_methlab02_v1.4.8/lua/zmlab2/sh_custom_hooks.lua
...
hook.Add("zmlab2_OnMethMade", "zmlab2_OnMethMade_test", function(ply, frezzingTray, methEnt,mType,mAmount,mQuality)
    ...
    /*
        methEnt can either be a meth bag or a meth crate, depending if the Freezer tray is put on a packing table or not
    */
end)
